  ...
  <div style="width: 80%">
    ...
    <el-form :inline="true" :model="form"  :rules="rules" ref="ruleForm" label-width="100px">
      ...
      <el-form-item label="所需积分" prop="score">
        <el-input-number v-model="form.score" :min="1" :max="10" label="所需积分"></el-input-number>
      </el-form-item>
      <br>
      <el-form-item label="封面" prop="cover">
        <el-upload
            class="avatar-uploader"
            :action="'http://localhost:2222/api/book/file/upload?token=' + this.admin.token"
...
export default {
  ...
  methods: {
    ...
    save(){
      request.put/*后端如果是postMapping则用post,PutMapping则用put*/('book/update',this.form).then(res=>{
        if (res.code==='200') {
